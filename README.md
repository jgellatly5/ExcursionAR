# Excursion Web App OpenAPI Specification
[![Build Status](https://travis-ci.org/ambujpunn/Excursion_Web_Node.svg?branch=master)](https://travis-ci.org/ambujpunn/Excursion_Web_Node)
...
6. If you did everything correct, https://ambujpunn.github.io/Excursion_Web_Node/ will lead to your new docs
...
- Documentation(ReDoc): https://ambujpunn.github.io/Excursion_Web_Node/
- SwaggerUI: https://ambujpunn.github.io/Excursion_Web_Node/swagger-ui/
- Look full spec:
    + JSON https://ambujpunn.github.io/Excursion_Web_Node/swagger.json
    + YAML https://ambujpunn.github.io/Excursion_Web_Node/swagger.yaml
- Preview spec version for branch `[branch]`: https://ambujpunn.github.io/Excursion_Web_Node/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://ambujpunn.github.io/Excursion_Web_Node/ with url from the message: `Server started <url>`
